...
function SmallViewPost(props) {
  ...
  return (
    <>
      <div className="w-full md:w-11/12 h-full p-2 border border-black lg:hidden flex justify-center items-center">
