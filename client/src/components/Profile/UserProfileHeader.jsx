...
function UserProfileHeader() {
  return (
    <div className="flex lg:justify-center w-full h-2/5 mt-8">
      <div className="flex flex-row w-full lg:w-1/2 h-full">
        <div className="flex w-1/3 h-full justify-center items-center px-14 lg:px-4 xl:px-8">
        ...
        <div className="flex flex-col w-full ml-4">
          <section className="flex flex-col align-stretch box-border min-w-0 shrink relative">
            <div className="flex items-center flex-row shrink min-w-0 relative">
              <h2 className="text-3xl font-light mr-3">_himanshu_11_</h2>
              <button className="border-2 rounded mx-2 px-2">
            ...
            <div className="items-stretch box-border block flex-col relative align-baseline">
